...
extern const mutils_word64 tiger_table[4*256];
...
extern const mutils_word32 tiger_table[4*256][2];
...
tiger_compress(const mutils_word32 *str, mutils_word32 state[6])
{
  tiger_compress_macro(((mutils_word32*)str), ((mutils_word32*)state));
}
#endif
