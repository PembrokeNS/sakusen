...
void
sha512_sha384_update(struct sha512_sha384_ctx *ctx, const mutils_word8 *data, 
...
void
sha512_digest(const struct sha512_sha384_ctx *ctx, mutils_word8 *digest);

void
sha384_digest(const struct sha512_sha384_ctx *ctx, mutils_word8 *digest);
