...
static const mutils_word32 gost_sbox_1[256] = {
...
static const mutils_word32 gost_sbox_2[256] = {
...
static const mutils_word32 gost_sbox_3[256] = {
...
static const mutils_word32 gost_sbox_4[256] = {
...
static void gosthash_bytes(GostHashCtx * ctx, const mutils_word8 * buf, mutils_word32 bits)
{
	mutils_word32 i;
	mutils_word32 j;
...
void gosthash_update(GostHashCtx * ctx, const mutils_word8 * buf, mutils_word32 len)
{
	mutils_word32 i, j;
