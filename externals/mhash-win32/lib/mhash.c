...
WIN32DLL_DEFINE const mutils_word8 *mhash_get_hash_name_static(hashid type)
{
	mutils_word8 *ret = NULL;
...
WIN32DLL_DEFINE
mutils_boolean mhash(MHASH td, const void *plaintext, mutils_word32 size)
{
...
WIN32DLL_DEFINE
    MHASH mhash_hmac_init(const hashid type, void *key, mutils_word32 keysize,
			  mutils_word32 block)
{
	MHASH ret = MHASH_FAILED;
	MHASH tmptd;
