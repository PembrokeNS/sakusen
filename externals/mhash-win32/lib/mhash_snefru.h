...
void
snefru128_update(struct snefru_ctx *ctx, const mutils_word8 *data, mutils_word32 length);

void
snefru256_update(struct snefru_ctx *ctx, const mutils_word8 *data, mutils_word32 length);
...
void
snefru128_digest(const struct snefru_ctx *ctx, mutils_word8 *digest);

void
snefru256_digest(const struct snefru_ctx *ctx, mutils_word8 *digest);
