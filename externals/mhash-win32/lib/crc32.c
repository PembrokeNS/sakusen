 ...
 */
static const mutils_word32 crc32_table_b[256] =
{
...
static const mutils_word32 crc32_table[256] =
{
...
void
mhash_get_crc32(const mutils_word32 *crc, void *ret)
{
	mutils_word32 tmp;
	tmp = ~(*crc);
	/*
...
void
mhash_crc32(mutils_word32 *crc, const void *given_buf, mutils_word32 len)
{
	const mutils_word8 *p;
...
void
mhash_crc32b(mutils_word32 *crc, const void *buf, mutils_word32 len)
{
	const mutils_word8 *p;
