...
static const mutils_word32 SBOX[R * 256 * 2]= {
...
{
	const mutils_word32 st[4] = {16, 8, 16, 24};
 ...
 */
static void snefru_update(struct snefru_ctx *ctx, const mutils_word8 *data, mutils_word32 length,
...
void snefru128_update(struct snefru_ctx *ctx, const mutils_word8 *data, mutils_word32 length)
{
	snefru_update(ctx, data, length, SNEFRU128_DATA_SIZE, SNEFRU128_DIGEST_LEN);
}

void snefru256_update(struct snefru_ctx *ctx, const mutils_word8 *data, mutils_word32 length)
{
...
static void snefru_digest(const struct snefru_ctx *ctx, mutils_word8 *digest, mutils_word32 len)
{
	mutils_word32 i;
...
void snefru128_digest(const struct snefru_ctx *ctx, mutils_word8 *digest)
{
	snefru_digest(ctx, digest, SNEFRU128_DIGEST_LEN);
}

void snefru256_digest(const struct snefru_ctx *ctx, mutils_word8 *digest)
{
