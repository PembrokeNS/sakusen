...
void
whirlpool_update(struct whirlpool_ctx *ctx, const mutils_word8 *data, mutils_word32 length);

void
whirlpool_final(struct whirlpool_ctx *ctx);

void
whirlpool_digest(const struct whirlpool_ctx *ctx, mutils_word8 *digest);
