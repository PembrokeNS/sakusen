...
void sha256_init(struct sha256_ctx *ctx)
{
	...
	static const mutils_word32 H0[_SHA256_DIGEST_LENGTH] = {
...
static void sha256_block(struct sha256_ctx *ctx, const mutils_word8 *block)
{
...
void
sha256_update(struct sha256_ctx *ctx, const mutils_word8 *buffer, mutils_word32 length)
{
	mutils_word32 left;
...
void sha256_digest(const struct sha256_ctx *ctx, mutils_word8 *s)
{
	mutils_word32 i;
