...
WIN32DLL_DEFINE int mutils_mlock(__const void *addr, __const mutils_word32 len);
WIN32DLL_DEFINE int mutils_munlock(__const void *addr, __const mutils_word32 len);
...
WIN32DLL_DEFINE void mutils_bzero(void *s, __const mutils_word32 n);

WIN32DLL_DEFINE void mutils_memset(void *dest, __const mutils_word8 c, __const mutils_word32 n);
WIN32DLL_DEFINE void mutils_memcpy(void *dest, __const void *src, __const mutils_word32 n);
WIN32DLL_DEFINE void mutils_memmove(void *dest, __const void *src, __const mutils_word32 n);
...
WIN32DLL_DEFINE mutils_word8 *mutils_strcat(mutils_word8 *dest, __const mutils_word8 *src);
WIN32DLL_DEFINE mutils_word8 *mutils_strcpy(mutils_word8 *dest, __const mutils_word8 *src);
WIN32DLL_DEFINE mutils_word8 *mutils_strncpy(mutils_word8 *dest, __const mutils_word8 *src, __const mutils_word32 n);
...
WIN32DLL_DEFINE mutils_word8 *mutils_asciify(mutils_word8 *in, __const mutils_word32 len);
WIN32DLL_DEFINE mutils_boolean mutils_thequals(mutils_word8 *text, mutils_word8 *hash, __const mutils_word32 len);
