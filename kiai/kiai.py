...
userconfig("startup")
aboutdata = kdecore.KAboutData("kiai","",kdecore.i18n("Kiai"),"0.0.4 気持ち",kdecore.i18n("Sakusen client"),kdecore.KAboutData.License_Custom,kdecore.i18n("(c) 2007-10 IEG/lmm"),kdecore.i18n("none"),"none","md401@srcf.ucam.org") # necessary to keep a reference to this around, otherwise it gets GCed at the wrong time and we segfault. Call that a pykde bug.
