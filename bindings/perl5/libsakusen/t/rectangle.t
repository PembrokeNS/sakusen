...
$r1 = sakusen::SRectangle16->new();
isa_ok($r1, 'sakusen::SRectangle16');
ok($r1->isEmpty(), 'default Rectangle is empty');

$r2 = sakusen::SRectangle16->new(2, 3, 10, 12);
isa_ok($r2, 'sakusen::SRectangle16');
