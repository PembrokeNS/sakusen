...
void
sha256_sha224_update(struct sha256_sha224_ctx *ctx, const mutils_word8 *data, mutils_word32 length);

void
sha256_sha224_final(struct sha256_sha224_ctx *ctx);

void
sha256_digest(const struct sha256_sha224_ctx *ctx, mutils_word8 *digest);

void
sha224_digest(const struct sha256_sha224_ctx *ctx, mutils_word8 *digest);
