...
static const mutils_word64 K[80] = {
...
{
  /* Initial values */
	static const mutils_word64 H0[_SHA512_SHA384_STATE_LENGTH] = {
...
static void 
sha512_sha384_block(struct sha512_sha384_ctx *ctx, const mutils_word8 * block)
{
...
void
sha512_sha384_update(struct sha512_sha384_ctx *ctx, const mutils_word8 * buffer, 
...
static void 
sha512_sha384_digest(const struct sha512_sha384_ctx *ctx, mutils_word8 * s, mutils_word32 len)
{
	mutils_word32 i;
...
void sha512_digest(const struct sha512_sha384_ctx *ctx, mutils_word8 * s)
{
	sha512_sha384_digest(ctx, s, SHA512_DIGEST_SIZE / 8);
}

void sha384_digest(const struct sha512_sha384_ctx *ctx, mutils_word8 * s)
{
