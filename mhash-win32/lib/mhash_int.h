...
WIN32DLL_DEFINE mutils_boolean mhash(MHASH thread, const void *plaintext, mutils_word32 size);
...
MHASH hmac_mhash_init(const hashid type, void *key, mutils_word32 keysize,
		      mutils_word32 block);
