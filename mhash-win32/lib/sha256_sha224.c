...
static const mutils_word32 K[64] = {
...
void sha256_init(struct sha256_sha224_ctx *ctx)
{
	...
	static const mutils_word32 H0[_SHA256_SHA224_DIGEST_LENGTH] = {
...
static void sha256_sha224_block(struct sha256_sha224_ctx *ctx, const mutils_word8 *block)
{
...
void
sha256_sha224_update(struct sha256_sha224_ctx *ctx, const mutils_word8 *buffer, mutils_word32 length)
{
	mutils_word32 left;
...
void sha256_digest(const struct sha256_sha224_ctx *ctx, mutils_word8 * s)
{
	sha256_sha224_digest(ctx, s, SHA256_DIGEST_SIZE / 4);
}

void sha224_digest(const struct sha256_sha224_ctx *ctx, mutils_word8 * s)
{
