     ...
     const char *filename;
{
  ...
  /*printf("[tryall_dlopen] cur->info.filename=%s\n", cur->info.filename);*/
  while (loader)
    {
      /*printf("[tryall_dlopen] attempting a load\n");*/
      lt_user_data data = loader->dlloader_data;
     ...
     const char *dlname;
{
  ...
  /*printf("[tryall_dlopen_module] filename=%s\n", filename);*/
  ...
  if (dlname)
    {
      ...
      if (!installed)
        {
          /*printf("[find_module] trying to open not-installed version\n");
          printf("[find_module] dir=%s\n", dir);
          printf("[find_module] objdir=%s\n", objdir);
